...
def get_user_input(display : pygame.Surface,font : pygame.font.Font):
	pass
...
def activate(display: pygame.Surface, clock: pygame.time.Clock, FPS: int):
	...
	bg = pygame.image.load('assets/images/bureau2.png')
		...
		for event in pygame.event.get():
			...
			if event.type == pygame.KEYDOWN:
				if event.key == pygame.K_RETURN:
					print("enter")
				#user_input = font.render(get_user_input(display,font),True,Colors.GREEN)
				#print(user_input)
				#display.blit(user_input, (0, 0))
			end()
		end()
